...
public class MainActivity extends AppCompatActivity {
    ...
    Ya he puesto el ejemplo creando la carpeta "drawable-xxxhdpi", tu reto ahora
    será tomar las imágenes y redimensionarlas con GIMP o con un script, como tu prefieras.
